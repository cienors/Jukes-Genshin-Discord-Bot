...
async def lmfaoo(ctx, amount=99):
...
async def schedule(ctx):
	embed = discord.Embed(
	    title='Weekly Farming List',
	    description=
	    "Jukelyn's weekly farming list!",
	    colour=discord.Colour.red())

	embed.set_footer(text='GLHF.')  #Bottom Text
	embed.set_thumbnail(
	    url='https://cdn.discordapp.com/avatars/347216701055565827/dd8d8fea4dd82a780589bc98c8854201.webp?size=256'
	)  #Small Icon top right
	embed.set_author(
	    name='Jukelyn',
	    icon_url=
	...
	embed.add_field(name='Tuesday',
	                value='Diluc Talent Books',
	                inline=False)
	embed.add_field(name='Wednesday', value='Raiden Shogun Talent Scrolls', inline=False)
	embed.add_field(name='Thursday', value='Anything or just condense for tomorrow', inline=False)
	embed.add_field(name='Friday', value='Diluc Talent Books', inline=False)
	embed.add_field(name='Saturday', value='Raiden Shogun Talent Scrolls', inline=False)
